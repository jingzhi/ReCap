...
def readCamerasFromTransforms(
    ...
    cam_infos = []  # filter scene_info by envtype
...
def readNerfSyntheticInfo(scene_cfg):
    print("Reading Training Transforms")
    train_cam_infos = readCamerasFromTransforms(
        scene_cfg.source_path,
        scene_cfg.blender.train_transform,
        scene_cfg.white_background,
        scene_cfg.blender.extension,
    )
    if scene_cfg.eval:
        print("Reading Test Transforms")
        test_cam_infos = readCamerasFromTransforms(
            scene_cfg.source_path,
            scene_cfg.blender.test_transform,
            scene_cfg.white_background,
            scene_cfg.blender.extension,
        )
    else:
    ...
    ply_path = os.path.join(scene_cfg.source_path, "points3d.ply")
