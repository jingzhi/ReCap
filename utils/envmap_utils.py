# Take from https://github.com/sunset1995/py360convert/blob/master/py360convert/utils.py
import numpy as np
...
def cube_h2dicedict(cube_h, flip_up=True):
    assert cube_h.shape[0] * 6 == cube_h.shape[1]
    cube_list = cube_h2list(cube_h)
    ...
    for i, (sx, sy) in enumerate(sxy):
        ...
        elif i == 4 and flip_up:
            face = np.flip(face, axis=0)
        cube_dict[order[i]] = face
